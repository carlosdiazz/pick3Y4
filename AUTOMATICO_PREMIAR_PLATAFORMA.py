...
schedule.every().day.at(VARIABLES.KING_LOTTERY_DIA['HORA']).do(run, KING_LOTTERY_AM_PLATATAFORMA_MEGA)
schedule.every().day.at(VARIABLES.KING_LOTTERY_NOCHE['HORA']).do(run, KING_LOTTERY_PM_PLATATAFORMA_MEGA)
