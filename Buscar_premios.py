...
schedule.every().day.at("13:24:20").do(run_threaded, LOTERY_FLORIDA_AM)
schedule.every().day.at("13:24:20").do(run_threaded, LOTERY_FLORIDA_PM)
schedule.every().day.at("13:24:20").do(run_threaded, LOTERY_NEW_YORK_AM)
schedule.every().day.at("13:24:20").do(run_threaded, LOTERY_NEW_YORK_PM)
schedule.every().day.at("13:24:20").do(run_threaded, LOTERY_NEW_JERSEY_AM)
schedule.every().day.at("13:24:20").do(run_threaded, LOTERY_NEW_JERSEY_PM)
