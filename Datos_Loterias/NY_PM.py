...
NY_PM_USA_PICK3 = 'https://www.lotteryusa.com/new-york/numbers/'
NY_PM_USA_PICK4 = 'https://www.lotteryusa.com/new-york/win-4/'
...
NEW_YORK_PM_LOTTERYUSA = {
    'URL' : [NY_PM_PAGES, NY_PM_USA_PICK3, NY_PM_USA_PICK4],
    'PICK3' : [NY_P3_FECHA,NY_P3_NU1,NY_P3_NU2,NY_P3_NU3 ],
    'PICK4' : [NY_P4_FECHA,NY_P4_NU1,NY_P4_NU2,NY_P4_NU3,NY_P4_NU4 ]
}

NEW_YORK_AM_TODO = [NEW_YORK_PM_LOTTERYUSA ]