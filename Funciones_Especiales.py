...
def saber_sorteo_picks(Nombre_Plataforma,sorteo,loteria, _3_or_4):
    ...
    if(Nombre_Plataforma == 'SANCHEZ'):
        ...
        if(sorteo == 'MIDDAY'):
            return f'{_3_or_4} {loteria} MD'
        elif(sorteo == 'EVENING'):
            return f'{_3_or_4} {loteria} PM'
        elif(sorteo == 'NIGHT'):
            return f'{_3_or_4} {loteria} NIGHT'
    else:
        if(sorteo == 'MIDDAY'):
            return f'{loteria} AM'
        elif(sorteo == 'EVENING'):
...
def Convertir_nombre_loteria(namePlataforma,loteria):
    ...
    if(namePlataforma == 'RAPIDITA'):
        ...
        if(loteria == OBJ_ANGUILLA_PM['LOTERIA']):
            return 'ANGUILA'
        elif(loteria == OBJ_PRIMERA_PM['LOTERIA']):
            return 'LA PRIMERA'
        else:
            return loteria
    else:
