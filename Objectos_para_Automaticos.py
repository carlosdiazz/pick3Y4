...
GEORGIA_AM_PLATAFORMA_MEGA          =   PREMIAR(VARIABLES.OBJ_GEORGIA_RD_AM, PLATAFORMA_MEGA, USER_MEGALOTTERY_SIN_CONFIRMAR).premiar
GEORGIA_PM_PLATAFORMA_MEGA          =   PREMIAR(VARIABLES.OBJ_GEORGIA_RD_PM, PLATAFORMA_MEGA, USER_MEGALOTTERY_SIN_CONFIRMAR).premiar
GEORGIA_NIGHT_PLATAFORMA_MEGA       =   PREMIAR(VARIABLES.OBJ_GEORGIA_RD_NIGHT, PLATAFORMA_MEGA, USER_MEGALOTTERY_SIN_CONFIRMAR).premiar
