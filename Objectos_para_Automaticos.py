...
#LOTERIAS EN LOTEDOM ---------------------------------------------------------------------------------
NEW_YORK_PM_LOTEDOM = PREMIAR(VARIABLES.VARIABLES.OBJ_NEW_YORK_RD_PM, PLATAFORMA_LOTEDOM, USER_LOTEDOM).premiar
FLORIDA_PM_LOTEDOM  = PREMIAR(VARIABLES,VARIABLES.OBJ_FLORIDA_RD_PM, PLATAFORMA_LOTEDOM, USER_LOTEDOM).premiar