...
SANCHEZ_MASSACHUSETTS_AM             =   PREMIAR(VARIABLES.OBJ_MA_AM, PLATAFORMA_SANCHEZ, USER_SANCHEZ).premiar
SANCHEZ_MASSACHUSETTS_PM             =   PREMIAR(VARIABLES.OBJ_MA_PM, PLATAFORMA_SANCHEZ, USER_SANCHEZ).premiar