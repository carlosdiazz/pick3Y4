...
from config import BOT_PREMIAR_MEGALOTTERY as BOT_MEGA, INTENTOS, TIEMPO_A_ESPERAR, URL_API_NODE_LAMERICANA
class PREMIAR():
    ...
    def premiar(self): #COntrolar desde aqui la diferente manera de premiar loteria dominicana y amaericana
        ...
        for intentos in range(INTENTOS):
            ...
            CONSULTA = CONSULTAR_NUMEROS_API(urlAPI,self.loteria,self.sorteo,self.fecha)
